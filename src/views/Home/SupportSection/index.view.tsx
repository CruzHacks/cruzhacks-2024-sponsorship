    ...
    <div className="SupportSection__container">
        ...
        <div className='SupportSection__container--SupportContainer'>
            ...
            <div className='SupportSection__container--SupportContainer--icons'>
                ...
                <SocialButton logo={Facebook} link={"https://www.facebook.com/CruzHacks/"} key={"https://www.facebook.com/CruzHacks/"} />
                <SocialButton logo={LinkedIn} link={"https://www.linkedin.com/company/cruzhacks/"} key={"https://www.linkedin.com/company/cruzhacks/"} />
                <SocialButton logo={Twitter} link={"https://twitter.com/CruzHacks"} key={"https://twitter.com/CruzHacks"} />
                <SocialButton logo={Discord} link={"https://discord.gg/NBUHWbmaeb"} key={"https://discord.gg/NBUHWbmaeb"} />
